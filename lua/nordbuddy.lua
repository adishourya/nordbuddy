...
v.g.colors_name = 'nordbuddy'
Color.new('mono_1', "#abb2bf")
Color.new('mono_2', "#828997")
Color.new('mono_3', "#5c6370")
Color.new('mono_4', "#4b5263")
Color.new('hue_1', "#81a1c1")
Color.new('hue_2', "#5e81ac")
Color.new('hue_3', "#B48EAD")
Color.new('hue_4', "#A3be8c")
Color.new('hue_5', "#e06c75")
Color.new('hue_5_2', "#bf616a")
Color.new('hue_6', "#d08770")
Color.new('hue_6_2', "#ebcb8b")
Color.new('syntax_bg', "#1a1d23")
Color.new('syntax_gutter', "#4c566a")
Color.new('syntax_cursor', "#1a1d23")
Color.new('syntax_accent', "#88c0d0")
Color.new('vertsplit', "#282c34")
Color.new('special_grey', "#3b4252")
Color.new('visual_grey', "#3b4252")
Color.new('pmenu', "#282c34")
Color.new('pink', "#f7afc0")
...
v.g.terminal_color_1  = "#bf616a"
v.g.terminal_color_9  = "#d08770"
v.g.terminal_color_2  = "#a3be8c"
v.g.terminal_color_10 = "#a3be8c"
v.g.terminal_color_3  = "#ebcb8b"
v.g.terminal_color_11 = "#ebcb8b"
v.g.terminal_color_4  = "#81a1c1"
v.g.terminal_color_12 = "#81a1c1"
v.g.terminal_color_5  = "#b48ead"
v.g.terminal_color_13 = "#b48ead"
v.g.terminal_color_6  = "#8fbcbb"
v.g.terminal_color_14 = "#8fbcbb"
v.g.terminal_color_7  = "#dbdee9"
v.g.terminal_color_15 = "#ffffff"
...
Group.new('LineNr',       c.mono_1,       c.none,      no)
Group.new('CursorLineNr', c.syntax_accent,       c.syntax_cursor,  no)
...
-- Group.new('StatusLineNC', c.hue_4,       c.none,      no)
...
Group.new('SignColumn',   c.none,         c.syntax_bg,         no)
...
-- built-in LSP
Group.new("LSPDiagnosticsWarning", c.hue_6_2, c.none)
Group.new("LSPDiagnosticsError", c.hue_5_2, c.none)
Group.new("LSPDiagnosticsInformation", c.pink, c.none)
Group.new("LSPDiagnosticsHint", c.pink, c.none)
